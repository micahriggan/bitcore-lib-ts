...
describe('BufferReader', () => {
  ...
  describe('#readUInt64LEBN', () => {
    ...
    it('should return 10BTC', () => {
      const tenbtc = 10 * 1e8;
      const tenbtcBuffer = new Buffer('00ca9a3b00000000', 'hex');
    ...
    it('should return 2^32 + 1', () => {
      ...
      const numBuffer = new Buffer('0100000001000000', 'hex');
    ...
    it('should return max number of satoshis', () => {
      ...
      const maxSatoshisBuffer = new Buffer('0040075af0750700', 'hex');
    ...
    it('should return 2^53 - 1', () => {
      ...
      const maxSafeBuffer = new Buffer('ffffffffffff1f00', 'hex');
    ...
    it('should return 2^53', () => {
      ...
      const bnBuffer = new Buffer('0000000000002000', 'hex');
  ...
  describe('#readVarintBN', () => {
    ...
    it('should read a 9 byte varint', () => {
      const buf = Buffer.concat([
        new Buffer([255]),
        new Buffer('ffffffffffffffff', 'hex')
      ]);
      const br = new BufferReader(buf);
      br.readVarintBN()
        .toNumber()
