  ...
  describe('instantiation', () => {
    ...
    it('problematic secp256k1 public keys', () => {
      const knownKeys = [
        {
          ...
          pub:
            '03d6106302d2698d6a41e9c9a114269e7be7c6a0081317de444bb2980bf9265a01',
          pubx:
        ...
        },
        {
          ...
          pub:
            '03e275faa35bd1e88f5df6e8f9f6edb93bdf1d65f4915efc79fd7a726ec0c21700',
          pubx:
      ...
      for (const key of knownKeys) {
        const privkey = new PrivateKey(key.wif);
        const pubkey = privkey.toPublicKey();
        pubkey.toString().should.equal(key.pub);
        pubkey.point.x.toString('hex').should.equal(key.pubx);
        pubkey.point.y.toString('hex').should.equal(key.puby);
      }
    });
