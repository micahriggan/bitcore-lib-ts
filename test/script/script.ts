...
describe('Script', () => {
  ...
  it('should make a new script when from is null', () => {
  ...
  describe('#fromBuffer', () => {
    ...
    it('should parse this buffer containing another OP code', () => {
      const buf = new Buffer(1);
      buf[0] = OP_CODES.OP_CHECKMULTISIG;
      const script = Script.fromBuffer(buf);
      script.chunks.length.should.equal(1);
      script.chunks[0].opcodenum.should.equal(buf[0]);
    });
    ...
    it('should parse this buffer an OP code, data, and another OP code', () => {
      ...
      buf[0] = OP_CODES.OP_0;
      buf[1] = OP_CODES.OP_PUSHDATA4;
      buf.writeUInt16LE(3, 2);
      buf[buf.length - 1] = OP_CODES.OP_0;
      const script = Script.fromBuffer(buf);
  ...
  describe('#fromASM', () => {
    it('should parse this known script in ASM', () => {
      ...
      script.chunks[0].opcodenum.should.equal(OP_CODES.OP_DUP);
      script.chunks[1].opcodenum.should.equal(OP_CODES.OP_HASH160);
      script.chunks[2].opcodenum.should.equal(20);
      script.chunks[2].buf
        .toString('hex')
        .should.equal('f4c03610e60ad15100929cc23da2f3a799af1725');
      script.chunks[3].opcodenum.should.equal(OP_CODES.OP_EQUALVERIFY);
      script.chunks[4].opcodenum.should.equal(OP_CODES.OP_CHECKSIG);
    });
  });
  ...
  describe('#toString', () => {
    ...
    it('should output this known script with pushdata1 opcode as ASM', () => {
      // network: livenet
  ...
  describe('#isDataOut', () => {
    it('should know this is a (blank) OP_RETURN script', () => {
      new Script('OP_RETURN').isDataOut().should.equal(true);
    });

    it('validates that this 40-byte OP_RETURN is standard', () => {
      const buf = new Buffer(40);
      buf.fill(0);
      new Script('OP_RETURN 40 0x' + buf.toString('hex'))
        .isDataOut()
        .should.equal(true);
    });
    it('validates that this 80-byte OP_RETURN is standard', () => {
      ...
      buf.fill(0);
      new Script('OP_RETURN OP_PUSHDATA1 80 0x' + buf.toString('hex'))
        .isDataOut()
        .should.equal(true);
    });
    ...
    it('validates that this 40-byte long OP_CHECKMULTISIG is not standard op_return', () => {
      const buf = new Buffer(40);
      buf.fill(0);
      new Script('OP_CHECKMULTISIG 40 0x' + buf.toString('hex'))
        .isDataOut()
        .should.equal(false);
    });
    ...
    it('validates that this 81-byte OP_RETURN is not a valid standard OP_RETURN', () => {
      ...
      buf.fill(0);
      new Script('OP_RETURN OP_PUSHDATA1 81 0x' + buf.toString('hex'))
        .isDataOut()
        .should.equal(false);
    });
  });
  ...
  describe('#isPublicKeyIn', () => {
    it('correctly identify scriptSig as a public key in', () => {
      ...
      const script = bitcore.Script.fromBuffer(scriptBuffer);
  ...
  describe('#isPublicKeyHashIn', () => {
    ...
    it('should identify this known non-pubkeyhashin (no signature)', () => {
      new Script('OP_DROP OP_CHECKSIG').isPublicKeyHashIn().should.equal(false);
    });
  });
  ...
  describe('#isPublicKeyHashOut', () => {
    ...
    it('should identify this known non-pubkeyhashout as not pubkeyhashout 2', () => {
      new Script('OP_DUP OP_HASH160 2 0x0000 OP_EQUALVERIFY OP_CHECKSIG')
        .isPublicKeyHashOut()
        .should.equal(false);
    });
  });
  ...
  describe('#isMultisigOut', () => {
    ...
    it('should identify non-multisig out 2', () => {
      new Script('OP_2').isMultisigOut().should.equal(false);
    });
  });
  ...
  describe('#isWitnessScriptHashOut', () => {
    it('should recognize this script as p2wsh', () => {
      new Script(
        'OP_0 32 0xa99d08fbec6958f4d4a3776c3728ec448934d25fe1142054b8b68bac866dfc3a'
      )
        .isWitnessScriptHashOut()
        .should.equal(true);
      new Script(
        '0020a99d08fbec6958f4d4a3776c3728ec448934d25fe1142054b8b68bac866dfc3a'
      )
        .isWitnessScriptHashOut()
        .should.equal(true);
    });
    it('should NOT identify as p2wsh', () => {
  ...
  describe('#isWitnessPublicKeyHashOut', () => {
    it('should identify as p2wpkh', () => {
      new Script('OP_0 20 0x799d283e7f92af1dd242bf4eea513c6efd117de2')
        .isWitnessPublicKeyHashOut()
        .should.equal(true);
      new Script('0014799d283e7f92af1dd242bf4eea513c6efd117de2')
        .isWitnessPublicKeyHashOut()
        .should.equal(true);
    });
    it('should NOT identify as p2wpkh', () => {
      new Script(
        'OP_0 32 0xa99d08fbec6958f4d4a3776c3728ec448934d25fe1142054b8b68bac866dfc3a'
      )
        .isWitnessPublicKeyHashOut()
  ...
  describe('#isWitnessProgram', () => {
    it('will default values to empty object', () => {
      new Script('OP_0 20 0x799d283e7f92af1dd242bf4eea513c6efd117de2')
        .isWitnessProgram()
        .should.equal(true);
    });
    it('will return false if script is data push longer than 40 bytes', () => {
      new Script(
        'OP_0 42 0xd06863c385592423903682926825c495b6cf88fd7cd6159ffd72f778ca475d3046e7b87835d3b457cd'
      )
        .isWitnessProgram()
        .should.equal(false);
    });
    it('will return false if first byte op_code is greater than OP_16', () => {
      new Script('OP_NOP 20 0x799d283e7f92af1dd242bf4eea513c6efd117de2')
        .isWitnessProgram()
        .should.equal(false);
    });
    it('will return true with datapush of 20', () => {
      ...
      values.program
        .toString('hex')
        .should.equal('799d283e7f92af1dd242bf4eea513c6efd117de2');
    });
    it('will return true with datapush of 32', () => {
      const values: Partial<Script.WitnessProgram> = {};
      new Script(
        'OP_0 32 0xc756f6d660d4aaad55534cac599a0d9bf5c7e8f70363d22926291811a168c620'
      )
        .isWitnessProgram(values)
        .should.equal(true);
      values.version.should.equal(0);
      values.program
        .toString('hex')
        .should.equal(
          'c756f6d660d4aaad55534cac599a0d9bf5c7e8f70363d22926291811a168c620'
        );
    });
  });
  ...
  describe('#isPushOnly', () => {
    it("should know these scripts are or aren't push only", () => {
      new Script('OP_NOP 1 0x01').isPushOnly().should.equal(false);
      new Script('OP_0').isPushOnly().should.equal(true);
      new Script('OP_0 OP_RETURN').isPushOnly().should.equal(false);
      new Script('OP_PUSHDATA1 5 0x1010101010').isPushOnly().should.equal(true);
      // like bitcoind, we regard OP_RESERVED as being "push only"
      new Script('OP_RESERVED').isPushOnly().should.equal(true);
    });
  });
  ...
  describe('#classifyInput', () => {
    ...
    it('should classify unknown', () => {
      new Script('OP_TRUE OP_FALSE')
        .classifyInput()
        .should.equal(Script.types.UNKNOWN);
    });
    it("should classify scriptHashIn, eventhough it's opreturn", () => {
      new Script('6a1c3630fd3792f7e847ae5e27985dfb127542ef37ac2a5147c3b9cec7ba')
        .classifyInput()
        .should.equal(Script.types.SCRIPTHASH_IN);
    });
  });
  ...
  describe('#isStandard', () => {
    it('should classify correctly standard script', () => {
      new Script('OP_RETURN 1 0x00').isStandard().should.equal(true);
    });
    it('should classify correctly non standard script', () => {
      new Script('OP_TRUE OP_FALSE').isStandard().should.equal(false);
    });
  });
  ...
  describe('#buildMultisigOut', () => {
    ...
    const sortkeys = pubKeyHexes.slice(0, 3).map(hex => new PublicKey(hex));
    ...
    const test_mn = (m, n) => {
      const pubkeys = pubKeyHexes.slice(0, n).map(hex => new PublicKey(hex));
  ...
  describe('#buildWitnessMultisigOutFromScript', () => {
    it('it will build nested witness scriptSig', () => {
      ...
      buf
        .slice(2, 34)
        .toString('hex')
        .should.equal(redeemHash.toString('hex'));
    });
  });
  ...
  describe('#buildPublicKeyHashOut', () => {
    it('should create script from livenet address', () => {
      ...
      s.toAddress()
        .toString()
        .should.equal('1NaTVwXDDUJaXDQajoa9MqHhz4uTxtgK14');
    });
    it('should create script from testnet address', () => {
      ...
      s.toAddress()
        .toString()
        .should.equal('mxRN6AQJaDi5R6KmvMaEmZGe3n5ScV9u33');
    });
  ...
  describe('#removeCodeseparators', () => {
    it('should remove any OP_CODESEPARATORs', () => {
      new Script('OP_CODESEPARATOR OP_0 OP_CODESEPARATOR')
  ...
  describe('toAddress', () => {
    ...
    it('works for p2pkh output', () => {
      ...
      script
        .toAddress()
        .toString()
        .should.equal('1KK9oz4bFH8c1t6LmighHaoSEGx3P3FEmc');
    });
    it('works for p2pkh input', () => {
      ...
      s2.toAddress()
        .toString()
        .should.equal('17VArX6GRE6i6MVscBUZoXwi6NhnHa68B7');
    });
    ...
    it('works for p2sh output', () => {
      ...
      script
        .toAddress()
        .toString()
        .should.equal('3FiMZ7stbfH2WG5JQ7CiuzrFo7CEnGUcAP');
    });
    it('works for p2sh input', () => {
      ...
      script
        .toAddress()
        .toString()
        .should.equal('3GYicPxCvsKvbJmZNBBeWkC3cLuGFhtrQi');
    });
  ...
  describe('equals', () => {
    ...
    it('returns false for different chunks sizes', () => {
      new Script('OP_TRUE')
        .equals(new Script('OP_TRUE OP_TRUE'))
        .should.equal(false);
    });
    it('returns false for different opcodes', () => {
      new Script('OP_TRUE OP_TRUE')
        .equals(new Script('OP_TRUE OP_FALSE'))
        .should.equal(false);
    });
    it('returns false for different data', () => {
      new Script()
        .add(new Buffer('a'))
        .equals(new Script('OP_TRUE'))
        .should.equal(false);
    });
    it('returns false for different data', () => {
      new Script()
        .add(new Buffer('a'))
        .equals(new Script().add(new Buffer('b')))
        .should.equal(false);
    });
  });
  ...
  describe('#getSignatureOperationsCount', () => {
    ...
    it('should default the one and only argument to true', () => {
      ...
      const trueCount = new Script(s1).getSignatureOperationsCount(true);
      const falseCount = new Script(s1).getSignatureOperationsCount(false);
      const defaultCount = new Script(s1).getSignatureOperationsCount();
